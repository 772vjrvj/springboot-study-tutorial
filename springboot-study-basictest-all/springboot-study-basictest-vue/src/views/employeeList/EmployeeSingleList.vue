<template>
  <div class = "container employeeList-container" @mousemove="empGripMouseMove" @mouseup="empGripMouseUp">
        ...
        <div class="text-start fs-4 mb-lg-5 position-relative"> Employees Single List.</div>
        <div class="ms-2 mb-lg-3 "><span>Total Row : {{this.pageObject.totalRow}}</span></div>
        <div class="row justify-content-between">
          ...
          <div class="col-auto">
            <b-button class="me-1" squared variant="outline-secondary" :disabled="selectedEmployees.length === 0"  v-b-modal.emp-delete>Delete</b-button>
            <b-button class="me-1" squared variant="outline-secondary">Create</b-button>
  ...
  data(){
    return {
      ...
      fields: [
        ...
        {key:'phoneNumber',    label:'Phone',           width: '90px',   filter: false, defaultWidth: '90px',  sort: 'asc'}, //8%
        {key:'hireDate',       label:'HireDate',        width: '90px',   filter: false, defaultWidth: '90px',  sort: 'asc'}, //10%
        {key:'jobId',          label:'JobId',           width: '100px',  filter: false, defaultWidth: '100px', sort: 'asc'}, //8%
