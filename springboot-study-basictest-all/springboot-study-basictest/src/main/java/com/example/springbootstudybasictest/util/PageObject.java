...
public class PageObject {
    ...
    public PageObject(int page, int perPageRow, int perGroupPage) {
        ...
        this.startRow = (page - 1)*perPageRow + 1;
        this.endRow = startRow + perPageRow -1;
    ...
    public void setTotalRow(int totalRow) {
        ...
        this.startRow = (this.page - 1) * this.perPageRow + 1;
        this.endRow = this.startRow + this.perPageRow - 1;
        ...
        this.lastPage = this.endPage < this.totalPage;         // 처음 페이지 존재 여부
        this.firstPage = this.perGroupPage < this.page;         // 마지막 페이지 존재 여부
